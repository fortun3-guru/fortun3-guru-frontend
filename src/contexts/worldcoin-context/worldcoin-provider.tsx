...
export default function WorldcoinProvider({
  ...
  useEffect(() => {
    ...
    let handleWalletAuthStart: ((data: any) => void) | null = null;
    let handleWalletAuthComplete: ((data: any) => void) | null = null;
    let handleWalletAuthError: ((data: any) => void) | null = null;
